        ...
        <div className="row">
          <div className="col-md-12 col-sm-12 col-md-1 col-lg-1">
            {showMsgDom && <div className="floatingmenu" id='msgOption' >
              <button type="button" className="button" onClick={this.handleCheck} name='sms'><div className="buttonicon"><i className="fa fa-bell text-red"></i></div><div className="buttonicontext">SMS</div></button>
              ...
              <button type="button" className="button" onClick={this.handleCheck} name='web'><div className="buttonicon"><i className="fa fa-mobile mobile text-red"></i></div><div className="buttonicontext">PUSH</div></button>
              {/* <ul>              
